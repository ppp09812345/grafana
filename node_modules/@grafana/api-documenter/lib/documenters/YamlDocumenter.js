...
class YamlDocumenter {
    ...
    _visitApiItems(apiItem, parentYamlFile) {
        ...
        if (this._shouldEmbed(apiItem.kind)) {
            ...
            if (parentYamlFile) {
                ...
                this._recordYamlReference(this._ensureYamlReferences(), this._getUid(apiItem), this._getYamlItemName(apiItem, { includeNamespace: !this.newDocfxNamespaces, includeSignature: true }), this._getYamlItemName(apiItem, { includeNamespace: true, includeSignature: true }));
            }
        }
        return true;
    }
    ...
    _generateYamlItem(apiItem) {
        ...
        if (apiItem.kind !== "Namespace" /* Namespace */ && apiItem.parent && apiItem.parent.kind === "Namespace" /* Namespace */ &&
        ...
        if (excerptTokens) {
            for (const token of excerptTokens) {
                if (token.kind === "Reference" /* Reference */) {
                    ...
                    const apiItem = specUid ? this._apiItemsByCanonicalReference.get(specUid) : undefined;
                    if (specUid) {
                        spec.uid = specUid;
                    }
    ...
    _getYamlItemName(apiItem, options = {}) {
        ...
        if ((includeNamespace || apiItem.kind === "Namespace" /* Namespace */) && apiItem.parent &&
