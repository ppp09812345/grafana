...
class Utilities {
    static getImportName(name) {
        return name.replace(Utilities._badFilenameCharsRegExp, '');
    }
    static getGrafanaConciseSignature(apiItem) {
        let displayName = apiItem.displayName;
        if (apiItem.kind === "ConstructSignature" /* ConstructSignature */ || apiItem.kind === "Constructor" /* Constructor */) {
    ...
    static getHeaderLinkForName(name) {
